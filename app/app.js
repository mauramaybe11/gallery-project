...
$(() => {
  ...
  $('#art-success-display, #art-error-display, #sign-up, #hide-new-art, #create-new-art-piece, #change-password-success-display, #change-password-error-display, #art-sign-in-form, #hide-sign-in-button, #hide-change-password-button, #show-index-art-pieces, #index-art-error-message, #hide-all-user-art, #see-all-user-art').hide()
